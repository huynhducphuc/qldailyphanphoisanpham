 ...
 * @author ThangAPT
 */
public class ViewInfoCity extends javax.swing.JFrame {
     ...
     */
    public ViewInfoCity(String id,Manage_City parent) {
        this.parent = parent;
        this.id = Integer.parseInt(id);
        initComponents();
        this.setVisible(true);
        setData();
        this.setTitle("Update City.");
        setDimension();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if ("".equals(cityName)) {
            ...
            if(cityService.updateCity(city)>0){
                JOptionPane.showMessageDialog(this, "<html>Update user successfulll. <br /></html>");
