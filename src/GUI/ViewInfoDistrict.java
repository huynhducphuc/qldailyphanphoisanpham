 ...
 * @author ThangAPT
 */
public class ViewInfoDistrict extends javax.swing.JFrame {
     ...
     */
    public ViewInfoDistrict(String id,Manage_District parent) {
        this.parent = parent;
        this.id = Integer.parseInt(id);
        initComponents();
        this.setVisible(true);
        this.setTitle("Update District.");
        setInfo();
        setDimension();
    }
    ...
    void setInfo(){
        ...
        district = new DistrictService().getDistrict(this.id);
        for (City c : list) {
            cbx_City.addItem(c.getCityName());
            if(c.getCityId()==district.getCityId())
                cbx_City.setSelectedItem(c.getCityName());
        }
        
        txtDistrictName.setText(district.getDistrictName());
    }
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Icons/data_disk.png"))); // NOI18N
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(jLabelalert, javax.swing.GroupLayout.DEFAULT_SIZE, 115, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if ("".equals(districtName)) {
            ...
            if (districtService.updateDistrict(district) > 0) {
                JOptionPane.showMessageDialog(this, "<html>Update district successfulll. <br /></html>");
